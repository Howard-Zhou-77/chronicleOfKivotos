...
import { lib } from "../../../noname/library/index.js";

/**
 * @param {string} name - 导入武将包
 * @returns {Promise<void>}
 */
export const importCharacterPackExt = generateImportFunction('character', (name) => `../../extension/乞国秘史/extension/${name}.js`)

/**
 * @param {string} name - 导入卡牌包
 * @returns {Promise<void>}
 */
export const importCardPackExt = generateImportFunction('card', (name) => `../../extension/乞国秘史/extension/${name}.js`)
